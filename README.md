...
📸 Screenshots
🏠 Home Screen
The main dashboard with key statistics and features.

https://1.png

Displays app statistics, accuracy metrics, multi-language support, and health tips.

📝 Symptom Input Screen
Intuitive interface for entering symptoms in English or Hindi.

https://2.png

Features common symptom selection, multi-language input, and smart suggestions for accurate diagnosis.

📊 Health Report Screen
Detailed diagnosis results with precautions and alternate diagnoses.

https://3.png

Shows interpreted symptoms, condition description, precautionary measures, and alternate possibilities.
